...
class UsersAdministrationViewScientistTablet extends StatefulWidget {
  ...
  @override
  _UsersAdministrationViewScientistTabletState createState() => _UsersAdministrationViewScientistTabletState();
}

class _UsersAdministrationViewScientistTabletState extends State<UsersAdministrationViewScientistTablet> {
          ...
          Scaffold(
              appBar: AppBar(
                  title: Row(
                      ...
                      children: <Widget>[
                        Text("Wissenschaftler-Menü", style: TextStyle(color: Colors.white, fontSize: 16), ),
                        Spacer(),
                        Text("Benutzerverwaltung", style: TextStyle(color: Colors.white, fontSize: 16), ),
                        Spacer(),
