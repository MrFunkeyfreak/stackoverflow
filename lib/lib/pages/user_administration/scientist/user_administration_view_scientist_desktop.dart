...
class UsersAdministrationViewScientistDesktop extends StatefulWidget {
  ...
  @override
  _UsersAdministrationViewScientistDesktopState createState() => _UsersAdministrationViewScientistDesktopState();
}

class _UsersAdministrationViewScientistDesktopState extends State<UsersAdministrationViewScientistDesktop> {
          ...
          Scaffold(
              appBar: AppBar(
                  title: Row(
                      ...
                      children: <Widget>[
                        Text("Wissenschaftler-Menü", style: TextStyle(color: Colors.white), ),
                        Spacer(),
                        Text("Benutzerverwaltung", style: TextStyle(color: Colors.white), ),
                        Spacer(),
