      ...
      children: <Widget>[
        Radio(
          activeColor: Theme
              .of(context)
              .primaryColor,
          value: gender[btnValue], //btnValue - shows the value of this button (0=male, 1=female)
          groupValue: genderSelected,  //will set the genderSelected when the button gets initialize (useful when a user gets editted - to show which gender is currently selected)
          onChanged: onChanged,   //function will set the onChanged when the button gets initialize
        ),
      ...
      children: <Widget>[
        Radio(
          activeColor: Theme
              .of(context)
              .primaryColor,
          value: role[btnValue],   //btnValue - shows the value of this button (0=user, 1=scientist, 2=admin)
          groupValue: roleSelected, //will set the roleSelected when the button gets initialize (useful when a user gets editted - to show which role is currently selected)
          onChanged: onChanged,  //function will set the onChanged when the button gets initialize
        ),
        Text(title)     // just the title of the radiobutton
      ],
